...
async def get_metrics_r2(credentials: HTTPBasicCredentials = Depends(verify_credentials_admin)):
...
async def get_metrics_rmse(credentials: HTTPBasicCredentials = Depends(verify_credentials_admin)):
